...
--
-- Host: db:3306
-- Generation Time: Oct 13, 2025 at 01:11 PM
...
-- Functions
--
CREATE DEFINER=`root`@`localhost` FUNCTION `fn_status_siswa` (`p_siswa_id` INT, `p_field` VARCHAR(100)) RETURNS VARCHAR(100) CHARSET utf8mb4 COLLATE utf8mb4_general_ci DETERMINISTIC BEGIN
...
--
-- Dumping data for table `mt_dokumen`
--
...
--
-- Table structure for table `mt_grading`
--
...
--
-- Dumping data for table `mt_grading`
--
...
--
-- Table structure for table `mt_grading_guru`
--
...
--
-- Table structure for table `mt_informasi`
--
...
--
-- Dumping data for table `mt_informasi`
--
...
--
-- Table structure for table `mt_kepala_sekolah`
--

CREATE TABLE `mt_kepala_sekolah` (
  `id` int NOT NULL,
...
--
-- Dumping data for table `mt_kepala_sekolah`
--

INSERT INTO `mt_kepala_sekolah` (`id`, `periode_id`, `nama_lengkap`, `nip`, `gelar_depan`, `gelar_belakang`, `tanggal_mulai`, `tanggal_selesai`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 1, 'Siti Hodijahzoioijoi', '197509192008012004', '', 'S.H., M.Pd.', '2018-07-01', '0000-00-00', 1, '2025-10-13 08:03:32', '2025-10-13 08:58:11');

-- --------------------------------------------------------

--
-- Table structure for table `mt_mata_pelajaran`
--
...
--
-- Dumping data for table `mt_mata_pelajaran`
--
...
--
-- Table structure for table `mt_periode`
--
...
--
-- Dumping data for table `mt_periode`
--
...
--
-- Table structure for table `mt_periode_semester`
--
...
--
-- Dumping data for table `mt_periode_semester`
--
...
--
-- Table structure for table `mt_sekolah`
--

CREATE TABLE `mt_sekolah` (
  `id` int NOT NULL,
  `nama_sekolah` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `npsn` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `nis` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nss` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nds` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `logo_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'assets/logo-sekolah.jpg',
  `is_active` tinyint DEFAULT '1',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Dumping data for table `mt_sekolah`
--

INSERT INTO `mt_sekolah` (`id`, `nama_sekolah`, `npsn`, `nis`, `nss`, `nds`, `alamat_lengkap`, `kode_pos`, `telepon`, `kelurahan`, `kecamatan`, `kabupaten_kota`, `provinsi`, `website`, `email`, `logo_path`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 'SMP NEGERI 1 RANCABUNGUR', '20200659', '2010202343390', NULL, NULL, 'Jalan Letkol Atang Senjaja, Desa Pasirgaok', '16310', '(0251) 8423707', 'Pasirgaok', 'Rancabungur', 'Bogor', 'Jawa Barat', 'http://smpn1rancabungur.sch.id', 'smpn1rancabungur@gmail.com', 'assets/logo-sekolah.jpg', 1, '2025-10-13 08:03:32', '2025-10-13 08:03:32');

-- --------------------------------------------------------

--
-- Table structure for table `mt_setting_lms`
--
...
--
-- Dumping data for table `mt_setting_lms`
--
...
--
-- Table structure for table `mt_setting_rapor`
--

CREATE TABLE `mt_setting_rapor` (
  `id` int NOT NULL,
  `code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
--
-- Dumping data for table `mt_setting_rapor`
--

INSERT INTO `mt_setting_rapor` (`id`, `code`, `value`, `description`, `updated_at`) VALUES
(1, 'kkm_default', '72', 'Kriteria Ketuntasan Minimal Default', '2025-10-13 08:03:32'),
(2, 'kota_tandatangan', 'Bogor', 'Kota untuk tanda tangan di rapor', '2025-10-13 08:03:32'),
(3, 'tampilkan_foto_siswa', '1', 'Tampilkan foto siswa di rapor (1=Ya, 0=Tidak)', '2025-10-13 08:03:32');

-- --------------------------------------------------------

--
-- Table structure for table `mt_status_periode`
--
...
--
-- Dumping data for table `mt_status_periode`
--
...
--
-- Table structure for table `mt_tingkat_kelas`
--
...
--
-- Dumping data for table `mt_tingkat_kelas`
--
...
--
-- Table structure for table `mt_users_guru`
--
...
--
-- Dumping data for table `mt_users_guru`
--
...
--
-- Table structure for table `mt_users_siswa`
--
...
CREATE TABLE `mt_users_siswa` (
  ...
  `jenis_kelamin` enum('Laki-laki','Perempuan') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'Laki-laki',
  `status_keluarga` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'Anak Kandung',
  `anak_ke` tinyint DEFAULT '1',
  `tanggal_diterima` date DEFAULT NULL,
  `kelas_diterima` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
--
-- Dumping data for table `mt_users_siswa`
--

INSERT INTO `mt_users_siswa` (`id`, `join_periode_id`, `users_id`, `current_kelas_id`, `nisn`, `nomor_induk`, `nama`, `tempat_lahir`, `tanggal_lahir`, `jenis_kelamin`, `status_keluarga`, `anak_ke`, `tanggal_diterima`, `kelas_diterima`, `agama`, `sekolah_asal`, `nomor_hp`, `status_siswa`, `alamat`, `deleted_at`) VALUES
(1, 1, 62, 1, '1220014', '25001', 'Muhammad Ichsan Fathurrochman', 'Jakarta', '1999-11-30', 'Perempuan', 'Anak Kandung', 10, '2001-02-20', 'VIII', 'Islam', 'SMPN 1 Jakarta', '81234567890', 'aktif', 'Jl. Merdeka No. 1, Jakarta', NULL),
(2, 1, 63, 1, '1220015', '25002', 'Annisa Putri', 'Bandung', '2000-05-15', 'Laki-laki', 'Anak Kandung', 1, NULL, NULL, 'Kristen', 'SMPN 2 Bandung', '87654321098', 'aktif', 'Jl. Asia Afrika No. 10, Bandung', NULL),
(3, 1, 64, 1, '1220016', '25003', 'Made Sanjaya', 'Denpasar', '1999-08-20', 'Laki-laki', 'Anak Kandung', 1, NULL, NULL, 'Hindu', 'SMPN 3 Denpasar', '85566778899', 'aktif', 'Jl. Gatot Subroto No. 5, Denpasar', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `mt_users_siswa_orangtua`
--
...
--
-- Dumping data for table `mt_users_siswa_orangtua`
--
...
(48, 'Reset Password', 0, '', 'fa-lock', 0, 9, '2025-10-13 13:07:33', '2025-10-13 20:09:28', NULL),
(49, 'Reset Password Siswa', 48, 'dashboard/reset_password', 'fa-circle', 0, 1, '2025-10-13 13:09:56', '2025-10-13 13:09:56', NULL),
(50, 'Reset Password Guru', 48, 'dashboard/reset_password_guru', 'fa-circle', 0, 2, '2025-10-13 13:10:29', '2025-10-13 13:10:29', NULL);
...
(65, 2, '123456789', 'Budi Santoso', '', '$2y$10$y9wliL.OATmIEdKvAs6KHOAvG5.72rtJlDSRddCHPzbq6sYx7YqUy', 'guru#456789', '2025-09-02 14:54:03', '2025-10-13 20:08:37', NULL),
(66, 2, '12345678910', 'Siti Aminah', '', '$2y$10$e.fJji4iepVY9Vv/Fvj3Zu32TDnFejfhC18PdMLRXghxFsnpRftly', 'guru#678910', '2025-09-02 14:54:03', '2025-10-13 20:10:40', NULL);
...
--
-- Table structure for table `tref_aspirasi`
--
...
--
-- Dumping data for table `tref_aspirasi`
--
...
--
-- Table structure for table `tref_guru_mata_pelajaran`
--
...
--
-- Dumping data for table `tref_guru_mata_pelajaran`
--
...
--
-- Table structure for table `tref_kelas`
--
...
--
-- Dumping data for table `tref_kelas`
--
...
--
-- Table structure for table `tref_kelas_jadwal_pelajaran`
--
...
--
-- Dumping data for table `tref_kelas_jadwal_pelajaran`
--
...
--
-- Table structure for table `tref_kelas_mata_pelajaran`
--
...
--
-- Dumping data for table `tref_kelas_mata_pelajaran`
--
...
--
-- Table structure for table `tref_kelas_siswa`
--
...
--
-- Dumping data for table `tref_kelas_siswa`
--
...
--
-- Table structure for table `tref_kelas_siswa_ekskul`
--
...
--
-- Dumping data for table `tref_kelas_siswa_ekskul`
--
...
--
-- Table structure for table `tref_konseling`
--
...
--
-- Dumping data for table `tref_konseling`
--
...
--
-- Table structure for table `tref_periode_mata_pelajaran`
--
...
--
-- Dumping data for table `tref_periode_mata_pelajaran`
--
...
--
-- Table structure for table `tref_pertemuan`
--
...
--
-- Dumping data for table `tref_pertemuan`
--
...
--
-- Table structure for table `tref_pertemuan_absensi`
--
...
--
-- Dumping data for table `tref_pertemuan_absensi`
--
...
--
-- Table structure for table `tref_pertemuan_diskusi`
--
...
--
-- Dumping data for table `tref_pertemuan_diskusi`
--
...
--
-- Table structure for table `tref_pertemuan_modul`
--
...
--
-- Dumping data for table `tref_pertemuan_modul`
--
...
--
-- Table structure for table `tref_pertemuan_pranala_luar`
--
...
--
-- Dumping data for table `tref_pertemuan_pranala_luar`
--
...
--
-- Table structure for table `tref_pertemuan_tugas`
--
...
--
-- Dumping data for table `tref_pertemuan_tugas`
--
...
--
-- Table structure for table `tr_egrading_siswa`
--
...
--
-- Dumping data for table `tr_egrading_siswa`
--
...
--
-- Table structure for table `tr_rapor`
--
...
--
-- Dumping data for table `tr_rapor`
--
...
--
-- Indexes for table `mt_grading`
--
ALTER TABLE `mt_grading`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `mt_grading_guru`
--
ALTER TABLE `mt_grading_guru`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `mt_informasi`
--
ALTER TABLE `mt_informasi`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `mt_kepala_sekolah`
--
ALTER TABLE `mt_kepala_sekolah`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_periode` (`periode_id`),
  ADD KEY `idx_active` (`is_active`);

--
-- Indexes for table `mt_mata_pelajaran`
--
ALTER TABLE `mt_mata_pelajaran`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `mt_periode`
--
ALTER TABLE `mt_periode`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `mt_periode_semester`
--
ALTER TABLE `mt_periode_semester`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `mt_sekolah`
--
ALTER TABLE `mt_sekolah`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `mt_setting_rapor`
--
ALTER TABLE `mt_setting_rapor`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`),
  ADD KEY `idx_code` (`code`);

--
-- Indexes for table `mt_status_periode`
--
ALTER TABLE `mt_status_periode`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `mt_tingkat_kelas`
--
ALTER TABLE `mt_tingkat_kelas`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `mt_users_guru`
--
ALTER TABLE `mt_users_guru`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `mt_users_siswa`
--
ALTER TABLE `mt_users_siswa`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `mt_users_siswa_orangtua`
--
ALTER TABLE `mt_users_siswa_orangtua`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `m_menu`
  ...
  ADD KEY `name` (`name`,`routes`,`icon`,`is_config`),
...
ALTER TABLE `m_users`
  ADD PRIMARY KEY (`id`),
  ADD KEY `role` (`user_group_id`,`name`,`email`,`created_at`),
...
--
-- Indexes for table `tref_aspirasi`
--
ALTER TABLE `tref_aspirasi`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tref_kelas`
--
ALTER TABLE `tref_kelas`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tref_kelas_jadwal_pelajaran`
--
ALTER TABLE `tref_kelas_jadwal_pelajaran`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tref_kelas_siswa`
--
ALTER TABLE `tref_kelas_siswa`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tref_kelas_siswa_ekskul`
--
ALTER TABLE `tref_kelas_siswa_ekskul`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tref_konseling`
--
ALTER TABLE `tref_konseling`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `tref_pertemuan`
--
ALTER TABLE `tref_pertemuan`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tref_pertemuan_absensi`
--
ALTER TABLE `tref_pertemuan_absensi`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tref_pertemuan_diskusi`
--
ALTER TABLE `tref_pertemuan_diskusi`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `tref_pertemuan_modul`
--
ALTER TABLE `tref_pertemuan_modul`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `tref_pertemuan_pranala_luar`
--
ALTER TABLE `tref_pertemuan_pranala_luar`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `tref_pertemuan_tugas`
--
ALTER TABLE `tref_pertemuan_tugas`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `tr_egrading_siswa`
--
ALTER TABLE `tr_egrading_siswa`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tr_rapor`
--
ALTER TABLE `tr_rapor`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `mt_grading`
--
ALTER TABLE `mt_grading`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `mt_grading_guru`
--
ALTER TABLE `mt_grading_guru`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `mt_informasi`
--
ALTER TABLE `mt_informasi`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `mt_kepala_sekolah`
--
ALTER TABLE `mt_kepala_sekolah`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `mt_mata_pelajaran`
--
ALTER TABLE `mt_mata_pelajaran`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `mt_periode`
--
ALTER TABLE `mt_periode`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `mt_periode_semester`
--
ALTER TABLE `mt_periode_semester`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `mt_sekolah`
--
ALTER TABLE `mt_sekolah`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `mt_setting_rapor`
--
ALTER TABLE `mt_setting_rapor`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `mt_status_periode`
--
ALTER TABLE `mt_status_periode`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `mt_tingkat_kelas`
--
ALTER TABLE `mt_tingkat_kelas`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `mt_users_guru`
--
ALTER TABLE `mt_users_guru`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `mt_users_siswa`
--
ALTER TABLE `mt_users_siswa`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `mt_users_siswa_orangtua`
--
ALTER TABLE `mt_users_siswa_orangtua`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT for table `m_users_group`
--
ALTER TABLE `m_users_group`
  MODIFY `id_grup` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `tref_aspirasi`
--
ALTER TABLE `tref_aspirasi`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tref_kelas`
--
ALTER TABLE `tref_kelas`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `tref_kelas_jadwal_pelajaran`
--
ALTER TABLE `tref_kelas_jadwal_pelajaran`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tref_kelas_siswa`
--
ALTER TABLE `tref_kelas_siswa`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `tref_kelas_siswa_ekskul`
--
ALTER TABLE `tref_kelas_siswa_ekskul`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tref_konseling`
--
ALTER TABLE `tref_konseling`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tref_pertemuan`
--
ALTER TABLE `tref_pertemuan`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `tref_pertemuan_absensi`
--
ALTER TABLE `tref_pertemuan_absensi`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT for table `tref_pertemuan_diskusi`
--
ALTER TABLE `tref_pertemuan_diskusi`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `tref_pertemuan_modul`
--
ALTER TABLE `tref_pertemuan_modul`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tref_pertemuan_pranala_luar`
--
ALTER TABLE `tref_pertemuan_pranala_luar`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `tref_pertemuan_tugas`
--
ALTER TABLE `tref_pertemuan_tugas`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `tr_egrading_siswa`
--
ALTER TABLE `tr_egrading_siswa`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `tr_rapor`
--
ALTER TABLE `tr_rapor`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `m_users`
  ADD CONSTRAINT `m_users_ibfk_1` FOREIGN KEY (`user_group_id`) REFERENCES `m_users_group` (`id_grup`);
COMMIT;
