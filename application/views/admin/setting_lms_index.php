    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="alert alert-info" role="alert">
          <i class="fa fa-info-circle"></i> <strong>Info:</strong> Setting Menu Aspirasi telah dipindahkan ke halaman <a href="<?= base_url('dashboard/aspirasi') ?>" class="alert-link">Aspirasi</a>.
        </div>
        <br>
        <div class="row">
          <div class="col-md-12">
