...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4">
    <div class="sidebar">
      <a href="<?php echo base_url('guru/dashboard') ?>" class="nav-link custom-brand-container">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item "><a href="<?= base_url('guru/e-grading') ?>" class="nav-link"><i class="nav-icon fas fa-clipboard"></i><p>Rekap Nilai Akhir</p></a></li>
          <li class="nav-item "><a href="<?= base_url('guru/setting/e-grading') ?>" class="nav-link"><i class="nav-icon fas fa-cog"></i><p>Setting Grading</p></a></li>
          <li class="nav-item "><a href="<?= base_url('guru/dokumen') ?>" class="nav-link"><i class="nav-icon fas fa-file"></i><p>Dokumen</p></a></li>
          
          <?php if (!empty($wali_kelas)): ?>
            <hr style="width: 100%">
            <li class="nav-item">
              <div class="nav-link" style="cursor: default;">
                <p><span class="badge badge-info">Menu Wali Kelas</span></p>
              </div>
            </li>
            <li class="nav-item "><a href="<?= base_url('guru/wali-kelas/siswa') ?>" class="nav-link"><i class="nav-icon fas fa-user"></i><p>Data Siswa</p></a></li>
            <li class="nav-item "><a href="<?= base_url('guru/wali-kelas/lms') ?>" class="nav-link"><i class="nav-icon fas fa-book"></i><p>Pantau LMS</p></a></li>
            <li class="nav-item "><a href="<?= base_url('guru/wali-kelas/konseling') ?>" class="nav-link"><i class="nav-icon fas fa-user"></i><p>Konseling</p></a></li>
            <li class="nav-item "><a href="<?= base_url('guru/wali-kelas/e-rapor') ?>" class="nav-link"><i class="nav-icon fas fa-clipboard"></i><p>E-Rapor Wali Kelas</p></a></li>
          <?php endif; ?>
        </ul>
      </nav>
    </div>
